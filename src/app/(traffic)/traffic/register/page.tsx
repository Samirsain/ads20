...
export default function TrafficRegisterPage() {
  ...
  return (
    <div className="flex min-h-[calc(100vh-2rem)] items-center justify-center relative overflow-hidden -m-4 md:-m-8">
      ...
      <div className="w-full max-w-md bg-slate-900/40 backdrop-blur-xl border border-slate-800 rounded-3xl p-8 shadow-2xl relative z-10 my-8">
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-white tracking-tight">Create Traffic Account</h1>
          <p className="text-slate-400 text-sm mt-1">Join as a traffic provider and earn</p>
        </div>
        ...
        <div className="mt-8 text-center text-sm text-slate-400">
          ...
          <Link href="/traffic/login" className="text-teal-400 hover:underline font-semibold">
            Sign In
          </Link>
        </div>
      </div>
