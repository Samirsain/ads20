            ...
            <form onSubmit={handleWithdraw} className="space-y-5">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-slate-950/60 border border-slate-800 focus:border-teal-500 rounded-xl px-4 py-3 text-white placeholder-slate-500 focus:outline-none focus:ring-1 focus:ring-teal-500 transition font-mono"
                  placeholder="500.00"
                />
              ...
              <button
                type="submit"
                disabled={requesting}
                className="w-full flex items-center justify-center gap-2 bg-gradient-to-r from-teal-500 to-emerald-600 hover:from-teal-400 hover:to-emerald-500 text-white font-medium rounded-xl py-3 shadow-lg shadow-teal-600/15 hover:shadow-teal-600/25 active:scale-[0.98] transition disabled:opacity-50 mt-4"
              >
                {requesting ? (
                  <>
