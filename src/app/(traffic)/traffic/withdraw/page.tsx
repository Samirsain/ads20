            ...
            <form onSubmit={handleWithdraw} className="space-y-4">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-slate-950/60 border border-slate-800 focus:border-teal-500 rounded-xl pl-7 pr-4 py-3 text-white placeholder-slate-500 focus:outline-none focus:ring-1 focus:ring-teal-500 transition font-mono"
                    placeholder="50.00"
                  />
                </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full bg-slate-950/60 border border-slate-800 focus:border-teal-500 rounded-xl px-4 py-3 text-white placeholder-slate-500 focus:outline-none focus:ring-1 focus:ring-teal-500 transition font-mono text-xs"
              ...
              <div className="space-y-3">
                {withdrawals.map((w) => (
                  <div key={w.id} className="bg-slate-950/60 border border-slate-800 rounded-2xl p-4 hover:border-slate-700 transition-colors">
                    ...
                    <p className="font-mono text-xs text-slate-400 truncate">{w.walletAddress}</p>
