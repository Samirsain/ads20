            ...
            <form onSubmit={handleWithdraw} className="space-y-4">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-white border border-slate-300 focus:border-blue-500 rounded-xl pl-7 pr-4 py-3 text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-1 focus:ring-blue-500 transition font-mono"
                    placeholder="50.00"
                  />
                </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full bg-white border border-slate-300 focus:border-blue-500 rounded-xl px-4 py-3 text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-1 focus:ring-blue-500 transition font-mono text-xs"
                ...
                {withdrawals.map((w) => (
                  <div key={w.id} className="bg-slate-50 border border-slate-200 rounded-2xl p-4 hover:border-slate-300 transition-colors">
                    <div className="flex flex-wrap items-center gap-3 mb-2">
                      ...
                      <span className="text-xs font-bold px-2 py-0.5 rounded-md bg-slate-50 border border-slate-200 text-slate-700">
                        {w.network}
                      </span>
                      {w.status === 'PENDING' && (
                    ...
                    <div className="flex items-center gap-2">
                      <p className="font-mono text-xs text-slate-500 truncate flex-1">{w.walletAddress}</p>
                      <button
                        onClick={() => copyAddress(w.walletAddress)}
                        className="shrink-0 p-1 rounded text-slate-400 hover:text-slate-700 transition"
                        title="Copy address"
                      >
